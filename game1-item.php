    ...
    <div class="container">
      <div class="-storage">
        ...
        <div class="btn-group mt-3" role="group">
          ...
          <a href="game1-item.php" class="btn btn-secondary active">ไอเทม</a>
        ...
        <div class="grid-storage -scroll -item">
          <div class="item have" data-type="Medicine">
            <a href="game1-info.php" class="storage-herb">
              <img src="assets/images/game1/item/img2.png">
            </a>
          </div>
          <div class="item have" data-type="Medicine">
            <a href="game1-info.php" class="storage-herb">
          ...
          <div class="item have" data-type="Medicine">
            <a href="game1-info.php" class="storage-herb">
              <img src="assets/images/game1/item/img1.png">
            </a>
          </div>
          <div class="item have" data-type="MixColors">
            <a href="game1-info.php" class="storage-herb">
              <img src="assets/images/game1/item/img4.png">
            </a>
          </div>
          <div class="item have" data-type="FabricDye">
            <a href="game1-info.php" class="storage-herb">
              <img src="assets/images/game1/item/img5.png">
            </a>
          </div>
